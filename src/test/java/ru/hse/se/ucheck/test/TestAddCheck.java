...
public class TestAddCheck {
    ...
    public void testEmptyCheck() {
        ...
        assertThrows(UCheckException.class, () -> uCheck.addCheck(check, Review.OK));
    }

    @Test
    public void testSimpleCheck() throws UCheckException {
        uCheck.addCheck(singleItemCheck, Review.OK);
        assertTrue(uCheck.getChecks().contains(singleItemCheck));
    }
    ...
    public void testNewItem() throws UCheckException {
        ...
        assertIterableEquals(List.of(singleItemCheck), uCheck.getItemsInfo().get(cocaCola.getCode()));
    }

    @Test
    public void testChangeStore() throws UCheckException {
        uCheck.addCheck(singleItemCheck, Review.OK);
        assertTrue(uCheck.getStoreInfo().containsKey(singleItemCheck.getStore()));
        assertIterableEquals(List.of(singleItemCheck),
